...
class TestMainPage:
    ...
    def test_samokat_logo_click_success(self, driver_firefox):
        ...
        assert main_page.get_url() == URL, f"Ожидали URL '{URL}', получили {main_page.get_url()}"
    ...
    def test_upper_order_button_click_success(self, driver_firefox):
        ...
        assert "/order" in main_page.get_url(), f"Ожидали URL '{URL}order', получили {main_page.get_url()}"
